...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Motorcycle</h1>
        ...
        <div class="row">
            <div class="col-xl-6 col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Data Tabel Merek Motor</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <tbody>
                                    @foreach ($motorcycleDetails as $index => $motorcycleDetail)
                                        <tr>
                                            <td scope="col" class="">{{ ++$index }}</td>
                                            <td scope="col" class="col-xl-6">
                                                {{ $motorcycleDetail->motorcycle->merek }}
                                            </td>
                                            <td scope="col">
                                                <div>
            ...
            <div class="col-xl-6 col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Data Tabel Model Motor</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="mb-2 p-2">
