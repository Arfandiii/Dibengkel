        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div class="mb-2 p-2">
                        <button class="btn btn-success"><i class="fa-solid fa-plus mr-1"></i>Add Car</button>
                    </div>
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($dataCar as $index => $car)
                                <tr>
                                    <td scope="col" class="">{{ ++$index }}</td>
                                    <td scope="col" class="col-lg-9 col-md-7 col-sm-5">{{ $car->merek }}</td>
